...
FpgaSPI4Class::FpgaSPI4Class(){
	...
	spi4.SPI_BaudRatePrescaler = SPI_BaudRatePrescaler_64;
...
int FpgaSPI4Class::ReadWrite(unsigned char* outReadData,unsigned char* writeData,int byteRwLength){
...
void FpgaSPI4Class::enableEXTI5(){
	EXTI->IMR |= EXTI_Line5;
}

void FpgaSPI4Class::disableEXTI5(){
	EXTI->IMR &= ~EXTI_Line5;
}

//void FpgaSPI4Class::waitForDataReady(){
...
void FpgaSPI4Class::myEXTI5_IRQHandler(){
	if(m_dataReadySem!=NULL){
...
void FpgaSPI4Class::myDMA2_Stream1_IRQHandler(){
