...
//	SPI2Class::GetInstance()->setTxBuf(11,Z_DELTVEL_OUT<<8);
	SPI2Class::GetInstance()->setTxBuf(0,X_GYRO_LOW<<8);
	SPI2Class::GetInstance()->setTxBuf(1,X_GYRO_OUT<<8);
	SPI2Class::GetInstance()->setTxBuf(2,Y_GYRO_LOW<<8);
	SPI2Class::GetInstance()->setTxBuf(3,Y_GYRO_OUT<<8);
	SPI2Class::GetInstance()->setTxBuf(4,Z_GYRO_LOW<<8);
	SPI2Class::GetInstance()->setTxBuf(5,Z_GYRO_OUT<<8);
	SPI2Class::GetInstance()->setTxBuf(6,X_ACCL_LOW<<8);
	SPI2Class::GetInstance()->setTxBuf(7,X_ACCL_OUT<<8);
	SPI2Class::GetInstance()->setTxBuf(8,Y_ACCL_LOW<<8);
	SPI2Class::GetInstance()->setTxBuf(9,Y_ACCL_OUT<<8);
	SPI2Class::GetInstance()->setTxBuf(10,Z_ACCL_LOW<<8);
	SPI2Class::GetInstance()->setTxBuf(11,Z_ACCL_OUT<<8);
	SPI2Class::GetInstance()->setTxBuf(12,X_MAGN_OUT<<8);
	SPI2Class::GetInstance()->setTxBuf(13,Y_MAGN_OUT<<8);
	SPI2Class::GetInstance()->setTxBuf(14,Z_MAGN_OUT<<8);
	SPI2Class::GetInstance()->setTxBuf(15,BAROM_LOW<<8);
	SPI2Class::GetInstance()->setTxBuf(16,BAROM_OUT<<8);
	SPI2Class::GetInstance()->setTxBuf(17,SYS_E_FLAG<<8);
